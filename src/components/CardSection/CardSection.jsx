...
const addClass = (smallRectangular, type) => {
  return classNames({
    [styles.card_smallRectangular]: smallRectangular === true && type === "card",
    [styles.content_smallRectangular]: smallRectangular === true && type === "content",
    [styles.title_smallRectangular]: smallRectangular === true && type === "title",
    [styles.wrapper_smallRectangular]: smallRectangular === true && type === "wrapper",
    [styles.image_smallRectangular]: smallRectangular === true && type === "image",
    [styles.description_smallRectangular]: smallRectangular === true && type === "description",
      ...
      {smallRectangular ? (
        ...
        <div className={addClass(smallRectangular, "content")}>
          ...
          <div className={addClass(smallRectangular, "wrapper")}>
            <img className={addClass(smallRectangular, "image")} src={cardImg} alt="card_img" />
            <p className={addClass(smallRectangular, "description")}>{description}</p>
          </div>
        </div>
    </div>
  );

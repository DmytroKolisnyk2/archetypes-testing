...
const SocialIcon = ({ link, bgColor, backgroundImg, width, height, top }) => {
  ...
  const socialIconsImg = {
    facebook:
      "https://dmytrokolisnyk2.github.io/ubermensches_project/build/images/team_facebook.png",
    instagram:
      "https://dmytrokolisnyk2.github.io/ubermensches_project/build/images/team_instamgram.png",
